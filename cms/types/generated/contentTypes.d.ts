...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['esg', 'japan-dev', 'servicenow', 'power-platform', 'digital']
    > &
...
export interface ApiConfigConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    companyAddress: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u5B81\u6CE2\u5E02\u911E\u5DDE\u533A\u5929\u7AE5\u5317\u8DEF933\u53F7\u548C\u90A6\u5927\u53A6A1802\u5BA4'>;
    companyEmail: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'nb_sales@rococo.co.jp'>;
    companyName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u5B81\u6CE2\u4E50\u79D1\u79D1\u4FE1\u606F\u6280\u672F\u6709\u9650\u516C\u53F8'>;
    companyPhone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'0574-28860655'>;
    ...
    heroSubtitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u6211\u4EEC\u7684\u52AA\u529B\u90FD\u662F\u4E3A\u4E86\u8BA9\u4FE1\u606F\u5316\uFF0C\u66F4\u5BB9\u6613'>;
    heroTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u6211\u4EEC\u7684\u8FFD\u6C42\u662F\u8BA9\u4FE1\u606F\u5316\u5207\u5B9E\u52A9\u529B\u4F01\u4E1A\u53D1\u5C55'>;
    icpNumber: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u6D59ICP\u590710037731\u53F7-5'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::config.config'
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<['news', 'notice']> &
